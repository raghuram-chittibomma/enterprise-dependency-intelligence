...
- Open-ended retrieval (`src/nlquery/graphrag.py`), Investigate (`src/investigate/`), Intelligence (`src/intelligence/`), config helpers, Ask/Investigate/Intelligence UI, faithfulness/refusal evals (`evals/test_mvp2_graphrag.py`, `evals/test_mvp3_hybrid.py`, `evals/test_mvp4_investigate.py`, `evals/test_mvp5_intelligence.py`) and fake-LLM / fake-embedder unit tests.

### Changed

- Docs: ARCHITECTURE, DATA_MODEL, PRODUCT_BRIEF, EVAL_STRATEGY, RUNBOOK updated for MVP2–MVP5 boundaries.
