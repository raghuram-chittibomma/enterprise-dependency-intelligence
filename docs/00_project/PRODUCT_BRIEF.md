...
## Functional requirements (MVP2 — Graph RAG)

| ID | Requirement | Increment |
|----|-------------|-------------|
| FR14 | When Graph RAG is enabled, ask an open-ended dependency question (outside the 7 closed templates) and receive a grounded answer over a retrieved subgraph. | increment-17-open-retrieve / increment-18-llm |
